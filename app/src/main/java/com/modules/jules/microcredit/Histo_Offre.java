...
public class Histo_Offre extends AppCompatActivity {

    private ListView listView;
    private ArrayList<Rech_histo_demande> histo = new ArrayList<Rech_histo_demande>();
    private CustomListHistoDema adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setSubtitle("Mes offres");

        mRelativeLayout = (RelativeLayout) findViewById(R.id.rel);

        listView = (ListView) findViewById(R.id.list_demande);
        adapter = new CustomListHistoDema(Histo_Offre.this, histo);
        listView.setAdapter(adapter);

        SharedPreferences pref = getApplicationContext().getSharedPreferences("infos", 0);

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,Config.HISTO_DEMANDE+"?telephone="+pref.getString("tel",null)+"&offre=1", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {

                        try {
                            JSONArray result = response.getJSONArray("result3");
                            ...
                            for (int i = 0; i < result.length(); i++) {
                                ...
                                hist.setCode(obj.getString("code"));
...
/*
                  ...
                  */
                                ...
                                Toast.makeText(Histo_Offre.this, "Vide", Toast.LENGTH_SHORT).show();
                                progressDialog.hide();
                                finish();
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Histo_Offre.this, "Erreur de connexion", Toast.LENGTH_SHORT).show();
                progressDialog.hide();
                finish();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Histo_Offre.this);
