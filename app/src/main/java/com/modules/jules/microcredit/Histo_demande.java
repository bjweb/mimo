...
public class Histo_demande extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ab.setSubtitle("Mes demandes");

        mRelativeLayout = (RelativeLayout) findViewById(R.id.rel);

        listView = (ListView) findViewById(R.id.list_demande);
        adapter = new CustomListHistoDema(Histo_demande.this, histo);
        listView.setAdapter(adapter);

        SharedPreferences pref = getApplicationContext().getSharedPreferences("infos", 0);

        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,Config.HISTO_DEMANDE+"?telephone="+pref.getString("tel",null)+"&demande=1", null, new Response.Listener<JSONObject>() {
            @Override
...
/*
                  ...
                  */
                                ...
                                Toast.makeText(Histo_demande.this, "Vide", Toast.LENGTH_SHORT).show();
                                progressDialog.hide();
                                finish();
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Histo_demande.this, "Erreur de connexion", Toast.LENGTH_SHORT).show();
                progressDialog.hide();
                finish();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Histo_demande.this);
